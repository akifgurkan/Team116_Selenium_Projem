...
public class P05 {
    public static void main(String[] args) throws InterruptedException {
        ...
        //driver.findElement(By.xpath("//button[@id='ez-accept-all']")).click(); // Cikan çerez kabul et penceresni asmak icin
        //driver.findElement(By.xpath("//a[text()='Tamam']")).click(); // Ya da bu kullanılabilir
